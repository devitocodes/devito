...
def test_forward_with_breaks():
    time_order = 2
    fw, gradop, u, rec_s, m0, src, rec_g, v, grad, rec_t, dm, nt, dt = cp_setup((150, 150), 750.0, (15.0, 15.0), time_order, 4, 40)
...
def test_acoustic_save_and_nosave(shape=(50, 50), spacing=(15.0, 15.0), tn=500., time_order=2, space_order=4, nbpml=10):
