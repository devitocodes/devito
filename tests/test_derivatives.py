...
class TestFD(object):
    ...
    @pytest.mark.parametrize('so, expected', [
        ...
        (4, '0.875*u(x)/h_x - 0.958333333*u(x - 1.0*h_x)/h_x + '
            '0.125*u(x + 1.0*h_x)/h_x - 0.0416666667*u(x + 2.0*h_x)/h_x'),
        (6, '1.078125*u(x)/h_x + 0.0369791667*u(x - 2.0*h_x)/h_x - '
            '1.1015625*u(x - 1.0*h_x)/h_x + 0.00520833333*u(x + 1.0*h_x)/h_x -'
            ' 0.0234375*u(x + 2.0*h_x)/h_x + 0.0046875*u(x + 3.0*h_x)/h_x'),
        (8, '1.14746094*u(x)/h_x - 0.00398995536*u(x - 3.0*h_x)/h_x + '
            '0.0602213542*u(x - 2.0*h_x)/h_x - 1.15722656*u(x - 1.0*h_x)/h_x - '
            '0.0406901042*u(x + 1.0*h_x)/h_x - 0.0099609375*u(x + 2.0*h_x)/h_x + '
            '0.0048828125*u(x + 3.0*h_x)/h_x - 0.000697544643*u(x + 4.0*h_x)/h_x')])
