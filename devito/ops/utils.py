...
namespace['ops_par_loop_range_name'] = 'par_loop_range'
namespace['ops_par_loop'] = 'ops_par_loop'
namespace['ops_arg_dat'] = 'ops_arg_dat'
namespace['ops_arg_gbl'] = 'ops_arg_gbl'
namespace['ops_read'] = 'OPS_READ'
namespace['ops_write'] = 'OPS_WRITE'
