...
class OperatorBasic(Function):
    ...
    def __init__(self, expressions, **kwargs):
        ...
        # Analysis 1 - required *also after* the StencilKernel construction
        self.dtype = self._retrieve_dtype(expressions)
        self.output = self._retrieve_output_fields(expressions)

        # Analysis 2 - required *for* the StencilKernel construction
    ...
    def _retrieve_loop_ordering(self, expressions):
        ...
        generated by the StencilKernel, based on the order in which dimensions
    ...
    def _retrieve_output_fields(self, expressions):
        """Retrieve the fields computed by the StencilKernel."""
