...
class Function(types.Function, Signer):
...
class TimeFunction(types.TimeFunction, Function):

    from_YASK = True

    @classmethod
    def __indices_setup__(cls, **kwargs):
        indices = list(types.TimeFunction.__indices_setup__(**kwargs))
