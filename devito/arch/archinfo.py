    ...
    if cuda.cudaDriverGetVersion(ctypes.byref(driver_version)) == 0 and \
       cuda.cudaRuntimeGetVersion(ctypes.byref(runtime_version)) == 0:
        ...
        if runtime_version < 11010:
            ...
            driver_version_major = int(driver_version.value/1000)
            runtime_version_major = int(runtime_version.value/1000)
            cuda_incompat = driver_versioni_major < runtime_version_major
