        ...
        if loc_idx is NONLOCAL:
            ...
            if comm_type is index_by_index:
                ...
                for j in range(nprocs):
                    ...
                    # FIXME: Hacked up for testing so tidy up. Should maybe write a
                    # function for this. Actually, should probably adjust
                    # `_set_global_idx`
                    # and remove idx_global (and just use idx below).
