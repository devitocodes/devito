...
class CireTransformer:
    ...
    def _aliases_from_clusters(self, cgroup, exclude, meta):
        ...
        schedule, exprs = self._select(variants, cgroup)
    ...
    def _select(self, variants, cgroup):
        """
        Select the best variant out of a set of `variants` extracted from `cgroup`,
        weighing flops and working set.
        """
        raise NotImplementedError
...
class CireInvariants(CireTransformerLegacy, Queue):
    ...
    def _select(self, variants, *args):
