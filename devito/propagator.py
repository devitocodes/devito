...
class Propagator(object):
    def __init__(self, name, nt, shape, spc_order=0, forward=True, time_order=0, openmp=False, profile=False,
        ...
        if self.cache_blocking and self.auto_tune:
            self.tune_b_size = 5  # initial optimal tuning block size. Depends on architecture
            self.tune_range = 2  # range of tuning around tune_b_size. make sure tune_b_size - tune_range > 0
