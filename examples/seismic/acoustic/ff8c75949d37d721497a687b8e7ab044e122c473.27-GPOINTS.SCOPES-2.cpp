...
int Forward(const float dt, const float o_x, const float o_y, const float o_z, struct dataobj *restrict rec_vec, struct dataobj *restrict rec_coords_vec, struct dataobj *restrict src_vec, struct dataobj *restrict src_coords_vec, struct dataobj *restrict u_vec, struct dataobj *restrict vp_vec, const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m, const int p_rec_M, const int p_rec_m, const int p_src_M, const int p_src_m, const int time_M, const int time_m, const int x0_blk0_size, const int y0_blk0_size, const int z0_blk0_size, struct profiler * timers)
{
  ...
  for (int time = time_m, t0 = (time)%(2), t2 = (time + 1)%(2); time <= time_M; time += 1, t0 = (time)%(2), t2 = (time + 1)%(2))
  {
    ...
    /* Begin section0 */
    #pragma acc parallel num_gangs(65535) vector_length(256) present(u,vp) deviceptr(r49,r50)
    {
      #pragma acc loop collapse(3)
      for (int x0_blk0 = x_m; x0_blk0 <= x_M; x0_blk0 += 16)
      {
        for (int y0_blk0 = y_m; y0_blk0 <= y_M; y0_blk0 += 4)
        {
          for (int z0_blk0 = z_m; z0_blk0 <= z_M; z0_blk0 += 32)
          {
            ...
            {
              for (int y = y0_blk0; y <= y0_blk0 + 3; y += 1)
              {
                for (int z = z0_blk0; z <= z0_blk0 + 31; z += 1)
                {
                  ...
                  /*
                  {
                    b += -7.93650813e-6F*(u[t0][x + 4][y + 8][z + 8] + u[t0][x + 8][y + 4][z + 8] + u[t0][x + 8][y + 8][z + 4] + u[t0][x + 8][y + 8][z + 12] + u[t0][x + 8][y + 12][z + 8] + u[t0][x + 12][y + 8][z + 8]);
                  }
                  {
                    b += 1.12874782e-4F*(u[t0][x + 5][y + 8][z + 8] + u[t0][x + 8][y + 5][z + 8] + u[t0][x + 8][y + 8][z + 5] + u[t0][x + 8][y + 8][z + 11] + u[t0][x + 8][y + 11][z + 8] + u[t0][x + 11][y + 8][z + 8]);
                  }
                  {
                    b += -8.8888891e-4F*(u[t0][x + 6][y + 8][z + 8] + u[t0][x + 8][y + 6][z + 8] + u[t0][x + 8][y + 8][z + 6] + u[t0][x + 8][y + 8][z + 10] + u[t0][x + 8][y + 10][z + 8] + u[t0][x + 10][y + 8][z + 8]);
                  }
                  {
                    b += 7.11111128e-3F*(u[t0][x + 7][y + 8][z + 8] + u[t0][x + 8][y + 7][z + 8] + u[t0][x + 8][y + 8][z + 7] + u[t0][x + 8][y + 8][z + 9] + u[t0][x + 8][y + 9][z + 8] + u[t0][x + 9][y + 8][z + 8]);
                  }
                  {
                    b += - 3.79629639e-2F*u[t0][x + 8][y + 8][z + 8];
                  }
                  */

                  
                  {
                    b += -7.93650813e-6F*(u[t0][x + 4][y + 8][z + 8] + u[t0][x + 12][y + 8][z + 8]) +
                          1.12874782e-4F*(u[t0][x + 5][y + 8][z + 8] + u[t0][x + 11][y + 8][z + 8]) +
                          -8.8888891e-4F*(u[t0][x + 6][y + 8][z + 8] + u[t0][x + 10][y + 8][z + 8]) +
                          7.11111128e-3F*(u[t0][x + 7][y + 8][z + 8] + u[t0][x + 9][y + 8][z + 8]);
                  }
                  {
                    b += -7.93650813e-6F*(u[t0][x + 8][y + 4][z + 8] + u[t0][x + 8][y + 12][z + 8]) +
                          1.12874782e-4F*(u[t0][x + 8][y + 5][z + 8] + u[t0][x + 8][y + 11][z + 8]) +
                          -8.8888891e-4F*(u[t0][x + 8][y + 6][z + 8] + u[t0][x + 8][y + 10][z + 8]) +
                          7.11111128e-3F*(u[t0][x + 8][y + 7][z + 8] + u[t0][x + 8][y + 9][z + 8]);
                  }
                  {
                    b += -7.93650813e-6F*(u[t0][x + 8][y + 8][z + 4] + u[t0][x + 8][y + 8][z + 12]) +
                          1.12874782e-4F*(u[t0][x + 8][y + 8][z + 5] + u[t0][x + 8][y + 8][z + 11]) +
                          -8.8888891e-4F*(u[t0][x + 8][y + 8][z + 6] + u[t0][x + 8][y + 8][z + 10]) +
                          7.11111128e-3F*(u[t0][x + 8][y + 8][z + 7] + u[t0][x + 8][y + 8][z + 9]);
                  }
                  {
                    b += - 3.79629639e-2F*u[t0][x + 8][y + 8][z + 8];
                  }
                  ...
                  u[t2][x + 8][y + 8][z + 8] = r49[x + 8][y + 8][z + 8]*(b + (-(-2.0F*u[t0][x + 8][y + 8][z + 8] + u[t2][x + 8][y + 8][z + 8]))*r50[x + 8][y + 8][z + 8]);
                }
              }
            }
          }
...
/* Backdoor edit at Sat Jan  9 00:32:03 2021*/ 
/* Backdoor edit at Sat Jan  9 00:32:46 2021*/ 
