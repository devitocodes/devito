      ...
      for (int y0_blk0 = y_m; y0_blk0 <= y_M; y0_blk0 += y0_blk0_size)
      {
        for (int z0_blk0 = z_m; z0_blk0 <= z_M; z0_blk0 += z0_blk0_size)
        {
          ...
          for (int y = y0_blk0; y <= y0_blk0 + y0_blk0_size - 1; y += 1)
          {
            ...
            {
              float r0 = u[t0][x_m + 4][y + 8][z + 8];
              float r1 = u[t0][x_m + 5][y + 8][z + 8];
              float r2 = u[t0][x_m + 6][y + 8][z + 8];
              float r3 = u[t0][x_m + 7][y + 8][z + 8];
              float r4 = u[t0][x_m + 8][y + 8][z + 8];
              float r5 = u[t0][x_m + 9][y + 8][z + 8];
              float r6 = u[t0][x_m + 10][y + 8][z + 8];
              float r7 = u[t0][x_m + 11][y + 8][z + 8];
              float r8 = u[t0][x_m + 12][y + 8][z + 8];

              #pragma acc loop seq
              for (int x = x_m; x <= x_M; x += 1)
              {
                u[t2][x + 8][y + 8][z + 8] = r49[x + 8][y + 8][z + 8]*r14*(-7.93650813e-6F*(r0 + u[t0][x + 8][y + 4][z + 8] + u[t0][x + 8][y + 8][z + 4] + u[t0][x + 8][y + 8][z + 12] + u[t0][x + 8][y + 12][z + 8] + r8) + 1.12874782e-4F*(r1 + u[t0][x + 8][y + 5][z + 8] + u[t0][x + 8][y + 8][z + 5] + u[t0][x + 8][y + 8][z + 11] + u[t0][x + 8][y + 11][z + 8] + r7) - 8.8888891e-4F*(r2 + u[t0][x + 8][y + 6][z + 8] + u[t0][x + 8][y + 8][z + 6] + u[t0][x + 8][y + 8][z + 10] + u[t0][x + 8][y + 10][z + 8] + r6) + 7.11111128e-3F*(r3 + u[t0][x + 8][y + 7][z + 8] + u[t0][x + 8][y + 8][z + 7] + u[t0][x + 8][y + 8][z + 9] + u[t0][x + 8][y + 9][z + 8] + r5) - 3.79629639e-2F*r4 + (-(-2.0F*r4 + u[t1][x + 8][y + 8][z + 8])*r15)*r50[x + 8][y + 8][z + 8]);
...
/* Backdoor edit at Tue Jan  5 17:02:32 2021*/ 
/* Backdoor edit at Tue Jan  5 17:24:45 2021*/ 
/* Backdoor edit at Tue Jan  5 19:50:13 2021*/ 
/* Backdoor edit at Tue Jan  5 21:23:46 2021*/ 
/* Backdoor edit at Fri Jan  8 00:58:38 2021*/ 
/* Backdoor edit at Fri Jan  8 16:20:30 2021*/ 
