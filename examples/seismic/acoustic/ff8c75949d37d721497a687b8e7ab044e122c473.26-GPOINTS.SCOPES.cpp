            ...
            for (int x = x0_blk0; x <= x0_blk0 + 15; x += 1)
            {
              for (int y = y0_blk0; y <= y0_blk0 + 3; y += 1)
              {
                for (int z = z0_blk0; z <= z0_blk0 + 31; z += 1)
                {
                  ...
                  u[t2][x + 8][y + 8][z + 8] = r49[x + 8][y + 8][z + 8]*(b - 3.79629639e-2F*u[t0][x + 8][y + 8][z + 8] + (-(-2.0F*u[t0][x + 8][y + 8][z + 8] + u[t2][x + 8][y + 8][z + 8]))*r50[x + 8][y + 8][z + 8]);
                }
              }
            }
          }
...
/* Backdoor edit at Fri Jan  8 22:24:02 2021*/ 
/* Backdoor edit at Fri Jan  8 22:24:34 2021*/ 
