...
int Forward(struct dataobj *restrict damp_vec, const float dt, const float o_x, const float o_y, const float o_z, struct dataobj *restrict rec_vec, struct dataobj *restrict rec_coords_vec, struct dataobj *restrict src_vec, struct dataobj *restrict src_coords_vec, struct dataobj *restrict u_vec, struct dataobj *restrict vp_vec, const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m, const int p_rec_M, const int p_rec_m, const int p_src_M, const int p_src_m, const int time_M, const int time_m, struct profiler * timers)
{
  ...
  for (int time = time_m, t0 = (time + 2)%(3), t1 = (time)%(3), t2 = (time + 1)%(3); time <= time_M; time += 1, t0 = (time + 2)%(3), t1 = (time)%(3), t2 = (time + 1)%(3))
  {
    ...
    for (int x = x_m; x <= x_M; x += 1)
    {
      for (int y = y_m; y <= y_M; y += 1)
      {
        for (int z = z_m; z <= z_M; z += 1)
        {
          ...
          u[t2][x + 4][y + 4][z + 4] = (r13*(-r14*(u[t0][x + 4][y + 4][z + 4] - 2.0F*u[t1][x + 4][y + 4][z + 4])) + r15*(damp[x + 1][y + 1][z + 1]*u[t1][x + 4][y + 4][z + 4]) - 3.70370379e-4F*(u[t1][x + 2][y + 4][z + 4] + u[t1][x + 4][y + 2][z + 4] + u[t1][x + 4][y + 4][z + 2] + u[t1][x + 4][y + 4][z + 6] + u[t1][x + 4][y + 6][z + 4] + u[t1][x + 6][y + 4][z + 4]) + 5.92592607e-3F*(u[t1][x + 3][y + 4][z + 4] + u[t1][x + 4][y + 3][z + 4] + u[t1][x + 4][y + 4][z + 3] + u[t1][x + 4][y + 4][z + 5] + u[t1][x + 4][y + 5][z + 4] + u[t1][x + 5][y + 4][z + 4]) - 3.33333341e-2F*u[t1][x + 4][y + 4][z + 4])/(r13*r14 + r15*damp[x + 1][y + 1][z + 1]);
        }
      }
    }
    /* End section0 */
    ...
    for (int p_rec = p_rec_m; p_rec <= p_rec_M; p_rec += 1)
    {
      ...
      {
        sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*px*py + 4.44445e-3F*px*pz - 6.66667e-2F*px + 4.44445e-3F*py*pz - 6.66667e-2F*py - 6.66667e-2F*pz + 1)*u[t1][ii_rec_0 + 4][ii_rec_1 + 4][ii_rec_2 + 4];
      }
      if (ii_rec_0 >= x_m - 1 && ii_rec_1 >= y_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_1 <= y_M + 1 && ii_rec_3 <= z_M + 1)
      {
        sum += (2.96296e-4F*px*py*pz - 4.44445e-3F*px*pz - 4.44445e-3F*py*pz + 6.66667e-2F*pz)*u[t1][ii_rec_0 + 4][ii_rec_1 + 4][ii_rec_3 + 4];
      }
      if (ii_rec_0 >= x_m - 1 && ii_rec_2 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_2 <= z_M + 1 && ii_rec_4 <= y_M + 1)
      {
        sum += (2.96296e-4F*px*py*pz - 4.44445e-3F*px*py - 4.44445e-3F*py*pz + 6.66667e-2F*py)*u[t1][ii_rec_0 + 4][ii_rec_4 + 4][ii_rec_2 + 4];
      }
      if (ii_rec_0 >= x_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_3 <= z_M + 1 && ii_rec_4 <= y_M + 1)
      {
        sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*py*pz)*u[t1][ii_rec_0 + 4][ii_rec_4 + 4][ii_rec_3 + 4];
      }
      if (ii_rec_1 >= y_m - 1 && ii_rec_2 >= z_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_1 <= y_M + 1 && ii_rec_2 <= z_M + 1 && ii_rec_5 <= x_M + 1)
      {
        sum += (2.96296e-4F*px*py*pz - 4.44445e-3F*px*py - 4.44445e-3F*px*pz + 6.66667e-2F*px)*u[t1][ii_rec_5 + 4][ii_rec_1 + 4][ii_rec_2 + 4];
      }
      if (ii_rec_1 >= y_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_1 <= y_M + 1 && ii_rec_3 <= z_M + 1 && ii_rec_5 <= x_M + 1)
      {
        sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*px*pz)*u[t1][ii_rec_5 + 4][ii_rec_1 + 4][ii_rec_3 + 4];
      }
      if (ii_rec_2 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_2 <= z_M + 1 && ii_rec_4 <= y_M + 1 && ii_rec_5 <= x_M + 1)
      {
        sum += (-2.96296e-4F*px*py*pz + 4.44445e-3F*px*py)*u[t1][ii_rec_5 + 4][ii_rec_4 + 4][ii_rec_2 + 4];
      }
      if (ii_rec_3 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_3 <= z_M + 1 && ii_rec_4 <= y_M + 1 && ii_rec_5 <= x_M + 1)
      {
        sum += 2.96296e-4F*px*py*pz*u[t1][ii_rec_5 + 4][ii_rec_4 + 4][ii_rec_3 + 4];
      }
      rec[time][p_rec] = sum;
    }
    /* End section2 */
...
/* Backdoor edit at Tue Dec  1 11:06:20 2020*/ 
/* Backdoor edit at Tue Dec  1 11:07:02 2020*/ 
