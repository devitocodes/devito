...
def Gzz_centered(field, costheta, sintheta, cosphi, sinphi, space_order):
    ...
    costheta : cos(Function) or Float
        cosine of the tilt angle
    sintheta : sin(Function) or Float
        sine of the tilt angle
    cosphi : cos(Function) or Float
        cosine of the azymuth angle
    sinphi : sin(Function) or Float
...
def ForwardOperator(model, geometry, space_order=4,
    ...
    model: Model
        Seismic TTI physical model
    geometry: None or Geometry
        Acquisition Geometry (source and receivers)
    kernel: 'centered' or 'staggered'
        Discretization type
    space_order: Int
