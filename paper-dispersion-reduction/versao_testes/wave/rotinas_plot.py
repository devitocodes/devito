...
def datasave(teste,rec,solplot,rec_select,ref,ptype,dttype):
    ...
    loc_save1_list = ['teste1/','teste2/','teste3/','teste4/','teste5/','teste6/','teste7/','teste8/','teste9/']
    ...
    if(ptype==6): local_save1 = loc_save1_list[5]
    if(ptype==7): local_save1 = loc_save1_list[6]
    if(ptype==8): local_save1 = loc_save1_list[7]
    if(ptype==9): local_save1 = loc_save1_list[8]
