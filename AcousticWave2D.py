...
class AcousticWave2D:
    ...
    def source_interpolate(self, x, y):
        if (abs(x - self.data.source_coords[0]) < self.h / 2 and
                abs(y - self.data.source_coords[1]) < self.h / 2):
            return 1
        else:
            return 0
                ...
                for b in range(1, ny-1):
                    ...
                    if ti == 0:
                        ...
                        u[ti, a, b] = self.ts(u[ti - 2, a, b],
                                              ...
                                              u[ti - 1, a, b + 1],
                                              src, m[a, b], dt, h, damp)
                    if a == (self.data.receiver_coords[0,2]):
                        rec[ti, b - 1] = u[ti, a, b]
        return rec, u
    ...
    def compute_gradient(self, model):
        ...
        res = rec - self.data.traces
        return self.Gradient(nt, res, u)
...
if __name__ == "__main__":
    ...
    self.data.receiver_coords[0,2] = 10 + 4
